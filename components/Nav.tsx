...
const Nav = () => {
  ...
  return (
    <nav style={{fontFamily: 'Marcellus'}} className='flex justify-between items-center sm:px-8 py-[2vh] font-sans '>
      ...
      <i onClick={() => setMenu("flex")} className="sm:hidden hover:cursor-pointer pr-4 text-xl font-bold ri-menu-2-fill " />
      <main 
      ...
      className={`z-50 fixed top-0 sm:hidden flex flex-col h-screen ${menu} items-center pt-[26vh] justify-flex-start bg-gradient-to-r from-[#373737] to-[#000000] w-full font-bold text-xl`}
