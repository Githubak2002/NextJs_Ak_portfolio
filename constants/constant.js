...
export const skills_tech_stack = {
  frontend: [
    {
      name: "Next js",
      path: "/skills/next.svg",
...
export const experience = [
  ...
  },
  {
    ...
    subTitle: "Frontend Developer || Jul - Aug 2023",
    details:
      "Started and Dived into REACT JS - a new journey towards Frontend Web developer. From here on ward, my journey as a Frontend developer began, creating projects with React.js, APIs, and Tailwind CSS etc...",
  },
  {
    title: "Smart India Hackathon (SIH 2023)",
    subTitle: "Smart India Hackathon || Sep 2023",
    details:
      "A dedicated member of the team name - Yuva Shakti Developing the solution website. Created a Full stack website with Firebase as real-time database.",
  },
  {
    title: "Industrial Training - SKIT Jaipur",
    subTitle: "Web Development || 18 Jul - 4 Aug 2022",
    details:
      "Developed UI of a website with different food items. Front-end using HTML, CSS and Bootstrap 5.",
  },
  // { title:"",
  //   subTitle:"",
  //   details:""
