  ...
  return (
    ...
    <section className=" font3Css md:px-4 px-0">
      ...
      <main className="mt-12 sm:mt-20 flexCenter gap-5 sm:gap-10 flex-wrap flex-col sm:flex-row px-3 sm:px-0">
        {projectsArray.map((ele, i) => (
          <div
            data-aos="zoom-in-up"
            key={i}
            className="border-[1px] border-white rounded-xl overflow-hidden flex flex-col gap-4 w-full sm:max-w-[420px] h-auto "
          >
            <Link
              href={ele.liveLink}
              target="blank"
              className="flexCenter w-fit overflow-hidden"
            >
              <Image
                src={ele.imgurl}
                alt="error"
      ...
      <main className="my-14 py-10 border-y-[1px] flexBetween flex-col sm:flex-row px-0 sm:px-4 w-full">
        ...
        <div
          data-aos="zoom-in-up"
          className="px-4 sm:px-6 mt-8 sm:mt-0 w-auto sm:w-[65%] text-center sm:text-left"
        >
          <h2 className="font-bold text-[#fa9750ef] text-2xl sm:text-4xl">
            {" "}
            <i className="ri-blender-fill pr-3 text-[#fa9750ef] " />{" "}
            {blender3D.title}
          </h2>
          <h2 className="leading-8 sm:leading-7 text-xl py-5 sm:py-4">
            {blender3D.subTitle}
          </h2>
          <p className=" leading-8 sm:leading-7 text-sm sm:text-base mb-4 text-center sm:text-left">
            {/* <p className=" leading-8 sm:leading-7 text-sm sm:text-base mb-4 sm:text-left text-justify"> */}
            {blender3D.detail}
          </p>
          <Link
            href={blender3D.link}
            target="blank"
            className="hover:underline hover:font-black text-blue-500"
          >
            All my 3D Render{" "}
            <i className="ri-external-link-line text-blue-500" />
          </Link>
        </div>
      </main>
      ...
      <h2
        data-aos="zoom-in"
        className="text-center text-xl sm:text-3xl my-6 txtOutlineCSS"
      >
        Minor <span className="px-1" />
        Porjects
      </h2>
      <main className="mt-10 sm:mt-16 flexCenter gap-5 sm:gap-10 flex-wrap flex-col sm:flex-row px-3 sm:px-0">
        {projectsArray2.map((ele, i) => (
          <div
            data-aos="zoom-in-up"
            key={i}
            className="border-[1px] border-white overflow-hidden flex flex-col gap-4 w-full sm:max-w-[280px] h-auto rounded-sm "
          >
            <Link
              href={ele.liveLink}
              target="blank"
            ...
            <h3 className="px-2 sm:px-3 font-thin text-base">
              {" "}
              {ele.content}{" "}
            </h3>
      ...
      <h2
        data-aos="zoom-in"
        className="text-center max-w-[580px] mx-auto mt-5 py-6 px-4 leading-8 sm:leading-7 "
      >
        {projInfo}
      </h2>
      <Link
        ...
        target="blank"
        className="border-2 w-fit mx-auto rounded-xl p-2 flexCenter transition-all hover:scale-110 hover:translate-y-[-5px] "
      >
        {" "}
        GITHUB <span className="ri-github-line font-thin  pl-2" />
      </Link>
